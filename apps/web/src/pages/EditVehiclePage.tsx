...
import { getListVehiclesQueryKey, useGetVehicle, useUpdateVehicle } from "@workspace/api-client-react";
import { useQueryClient } from "@tanstack/react-query";
import { VehicleFormFields, type VehicleFormState } from "@/components/vehicles/VehicleFormFields";
...
export default function EditVehiclePage({ params }: DetailPageParams) {
  ...
  const vehicleQuery = useGetVehicle(id);
